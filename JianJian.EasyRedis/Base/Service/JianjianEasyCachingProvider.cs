...
namespace JianJian.EasyRedis.Base.Service
{
    public class JianjianEasyCachingProvider : IJianjianEasyCachingProvider
    {
      //  private int DbNum { get; }
        ...
        #region 构造函数
        public JianjianEasyCachingProvider(IRedisDatabaseProvider dbProvider)
        {
            ArgumentCheck.NotNull(dbProvider, nameof(dbProvider));
            _dbProvider = dbProvider;
            _conn = _dbProvider.GetConnectionMultiplexer();
        ...
        {
            key = AddSysCustomKey(key);
            string json = CustConvertJson(obj);
        ...
        {
            key = AddSysCustomKey(key);
            Do(db => db.ListRemove(key, CustConvertJson(value)));
        }
        ...
        {
            key = AddSysCustomKey(key);
            Do(db => db.ListRightPush(key, CustConvertJson(value)));
        }
        ...
        {
            key = AddSysCustomKey(key);
            Do(db => db.ListLeftPush(key, CustConvertJson(value)));
        }
        ...
        {
            key = AddSysCustomKey(key);
            return await Do(db => db.ListRemoveAsync(key, CustConvertJson(value)));
        }
        ...
        {
            key = AddSysCustomKey(key);
            return await Do(db => db.ListRightPushAsync(key, CustConvertJson(value)));
        }
        ...
        {
            key = AddSysCustomKey(key);
            return await Do(db => db.ListLeftPushAsync(key, CustConvertJson(value)));
        }
        ...
        {
            key = AddSysCustomKey(key);
            return Do(redis => redis.SortedSetAdd(key, CustConvertJson<T>(value), score));
        }
        ...
        {
            key = AddSysCustomKey(key);
            return Do(redis => redis.SortedSetRemove(key, CustConvertJson(value)));
        }
        ...
        {
            key = AddSysCustomKey(key);
            return await Do(redis => redis.SortedSetAddAsync(key, CustConvertJson<T>(value), score));
        }
        ...
        {
            key = AddSysCustomKey(key);
            return await Do(redis => redis.SortedSetRemoveAsync(key, CustConvertJson(value)));
        }
        ...
        {
            ISubscriber sub = _conn.GetSubscriber();
            return sub.Publish(channel, CustConvertJson(msg));
        }
        ...
        {
            return _dbProvider.GetDatabase().CreateTransaction();// GetDatabase().CreateTransaction();
        }

        public IDatabase GetDatabase()
        {
            return _dbProvider.GetDatabase();// _conn.GetDatabase();
        }
        ...
        {
            var database = _dbProvider.GetDatabase();//_conn.GetDatabase();
            return func(database);
        }

        private string CustConvertJson<T>(T value)
        {
